...
contract DidManagerUnitTest is TestBase {
    ...
    function test_CreateDid_Should_CreateWithDefaultMethods_When_EmptyMethodsProvided() public {
        ...
        assertLt(didExpiration, block.timestamp + Fixtures.DID_MAX_EXPIRATION_PERIOD + Fixtures.TEST_EXPIRATION_BUFFER); // 4 years + 1 day buffer
        ...
        assertLt(vmExpiration, block.timestamp + Fixtures.VM_DEFAULT_EXPIRATION_PERIOD + Fixtures.TEST_EXPIRATION_BUFFER); // 1 year + 1 day buffer
    ...
    function test_UpdateController_Should_UseLastPosition_When_PositionExceedsMax() public {
        ...
        _startPrank(user1);
        DidTestHelpers.CreateDidResult memory ownerDid = DidTestHelpers.createDid(
            vm, didManager, DEFAULT_DID_METHODS, Fixtures.DEFAULT_RANDOM_0, bytes32(0)
        );
        DidTestHelpers.CreateDidResult memory controllerDid = DidTestHelpers.createDid(
            vm, didManager, DEFAULT_DID_METHODS, Fixtures.DEFAULT_RANDOM_1, bytes32(0)
        );
        _stopPrank();
    ...
    function test_CreateVm_Should_RevertWithDidExpired_When_TargetDidIsExpired() public {
        // Create two DIDs
        _startPrank(user1);
        DidTestHelpers.CreateDidResult memory senderDid = DidTestHelpers.createDid(
            vm, didManager, DEFAULT_DID_METHODS, Fixtures.DEFAULT_RANDOM_0, bytes32(0)
        );
    ...
    function test_CreateDid_Should_TriggerCleanupLoops_When_DataExists() public {
        ...
        DidTestHelpers.CreateDidResult memory firstDid = DidTestHelpers.createDid(
            vm, didManager, customMethods, randomValue, DEFAULT_VM_ID
        );
        ...
        DidTestHelpers.CreateDidResult memory secondDid = DidTestHelpers.createDid(
            vm, didManager, customMethods, bytes32("new-random"), DEFAULT_VM_ID
        );
    ...
    function test_RemoveAllFunctions_Should_HandleEmptyState_When_NoDataExists() public {
        ...
        DidTestHelpers.CreateDidResult memory didResult = DidTestHelpers.createDid(
            vm, didManager, Fixtures.CUSTOM_DID_METHODS, bytes32("empty-test"), DEFAULT_VM_ID
        );
        ...
        DidTestHelpers.CreateDidResult memory secondDid = DidTestHelpers.createDid(
            vm, didManager, Fixtures.CUSTOM_DID_METHODS, bytes32("empty-test-2"), DEFAULT_VM_ID
        );
    ...
    function test_ForceHashCollision_Should_TriggerCleanup_When_SameHashGenerated() public {
        ...
        // Create first DID
        DidTestHelpers.CreateDidResult memory originalDid = DidTestHelpers.createDid(
            vm, didManager, testMethods, testRandom, DEFAULT_VM_ID
        );
        ...
        DidTestHelpers.CreateDidResult memory newDid = DidTestHelpers.createDid(
            vm, didManager, testMethods, bytes32("force-cleanup"), DEFAULT_VM_ID
        );
    ...
    function test_CreateVm_Should_RevertWithNotAControllerforTargetId_When_SenderNotController() public {
        ...
        _startPrank(user1);
        DidTestHelpers.CreateDidResult memory controllerDid = DidTestHelpers.createDid(
            vm, didManager, DEFAULT_DID_METHODS, Fixtures.DEFAULT_RANDOM_2, bytes32(0)
        );
