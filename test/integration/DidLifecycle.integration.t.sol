...
contract DidLifecycleIntegrationTest is TestBase {
    ...
    function test_CompleteDidLifecycle_Should_WorkEndToEnd_When_AllStepsExecuted() public {
        ...
        DidTestHelpers.CreateDidResult memory aliceDid = DidTestHelpers.createDid(
            vm,
            didManager,
            Fixtures.EMPTY_DID_METHODS,
            bytes32("alice-random"),
            bytes32(0)
        );
        ...
        DidTestHelpers.CreateDidResult memory bobDid = DidTestHelpers.createDid(
            vm,
            didManager,
            Fixtures.EMPTY_DID_METHODS,
            bytes32("bob-random"),
        ...
        // Add assertion method VM
        {
            ...
            DidTestHelpers.CreateVmResult memory assertionVmResult = DidTestHelpers.createVm(vm, didManager, assertionVmCommand);
        ...
        // Add key agreement VM
        {
            ...
            DidTestHelpers.CreateVmResult memory keyAgreementVmResult = DidTestHelpers.createVm(vm, didManager, keyAgreementVmCommand);
        ...
        {
            DidTestHelpers.CreateVmResult memory bobControlledVmResult = DidTestHelpers.createVm(vm, didManager, bobControlledVmCommand);
        ...
        assertTrue(didManager.authenticate(
            aliceDid.didInfo.methods,
            aliceDid.didInfo.id,
            DEFAULT_VM_ID,
            alice
        ...
        assertTrue(didManager.isVmRelationship(
            aliceDid.didInfo.methods,
            aliceDid.didInfo.id,
            DEFAULT_VM_ID,
    ...
    function test_MultiUserInteraction_Should_WorkCorrectly_When_MultipleUsersCollaborate() public {
        ...
        assertTrue(didManager.authenticate(aliceDid.didInfo.methods, aliceDid.didInfo.id, bytes32("carol-managed-vm"), carol));
    }
